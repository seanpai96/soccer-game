        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    if (useSounds.boolValue == true) { ReachUIEditorHandler.DrawProperty(audioManager, customSkin, "Audio Manager"); }
                    break;
                ...
                case 2:
                    ...
                    invokeAtStart.boolValue = ReachUIEditorHandler.DrawToggle(invokeAtStart.boolValue, customSkin, "Invoke At Start", "Process events on awake.");
