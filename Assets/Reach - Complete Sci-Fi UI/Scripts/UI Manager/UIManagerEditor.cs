    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showLogo)
            {
                ...
                ReachUIEditorHandler.DrawProperty(brandLogoColor, customSkin, "Brand Logo Color");
                ReachUIEditorHandler.DrawProperty(gameLogo, customSkin, "Game Logo");
                ReachUIEditorHandler.DrawProperty(gameLogoColor, customSkin, "Game Logo Color");
            }
